...
(() => {
  ...
  const dict = {
    uk: {
      ...
      sort_name_asc:"Назва A→Я",
      sort_name_desc:"Назва Я→A",

      chip_all:"Усі",
      chip_core:"CORE",
      chip_yard:"YARD",
      chip_sets:"СІТКИ / СЕТИ",
    ...
    ru: {
      ...
      sort_name_asc:"Название A→Я",
      sort_name_desc:"Название Я→A",

      chip_all:"Все",
      chip_core:"CORE",
      chip_yard:"YARD",
      chip_sets:"СЕТКИ / СЕТЫ",
      ...
      about_title:"О нас",
      about_text:"BLACKWOOD • CHARCOAL — премиальный древесный уголь для гриля и BBQ. Линейки CORE и YARD, а также аксессуары: сетки, перчатки, щипцы и наборы.",
    ...
    en: {
      ...
      shipping_text:"Delivery across Ukraine. Orders processed daily. Typical delivery 1–3 days. Payment: card / cash / COD (by arrangement).",

      about_title:"About",
      about_text:"BLACKWOOD • CHARCOAL is premium hardwood charcoal for grill and BBQ. CORE and YARD lines plus accessories: mesh bags, gloves, tongs and kits.",
